    ...
    <View style={{ flex: 1 }}>
      <View style={{ height: ITEM_HEIGHT, overflow: "hidden" }}>
        ...
        <View style={styles.pagination}>
          ...
          <Animated.View
            style={[styles.indicator, { transform: [{ translateY }] }]}
          />
        </View>
      </View>
      <BottomSheet
...
const styles = StyleSheet.create({
  ...
  indicator: {
    ...
    height: DOT_SIZE + DOT_SPACING,
    borderRadius: DOT_SIZE + DOT_SPACING,
    borderColor: "#333",
    position: "absolute",
    top: DOT_SIZE / 2 - DOT_SPACING,
    left: DOT_SIZE / 2 - DOT_SPACING,
  },
});
